...
import cn.programingmonkey.Utils.Sift.ui.MainFrame;
...
public class Test {
	...
	public static void main(String[] args) throws IOException {
		...
		String source="/Users/caihongfeng/Downloads/test.jpg";
...
//		String target3="C:\\Documents and Settings\\Administrator\\桌面\\mySpace\\SimilarImageSearch\\images\\example3.jpg";
		...
		int [] pics=new int[15];
		for(int i=1;i<=1;i++){
			String target="/Users/caihongfeng/Downloads/test.jpg";
